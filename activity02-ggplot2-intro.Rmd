...
**Response**:
Gentoo has greater length that the other 2, the other two are similar
...
**Response**:
this is very similar to the boxplots
...
**Response**:
if i cahnged the alpha so the dots are less dark
...
**Response**:
you can see where the density variation of the dots are for the 
...
**Response**:
There is not much variability expect between the bill lenght and the species
...
**Response**:
you have a nice svm separation
